...
from src.api.v1.endpoints.unified_audio import router as unified_audio_router
...
app.add_middleware(
    ...
    allow_origins=[
        "*"
    ],  # 모든 도메인 허용하는것이나, 실제 프로덕션 환경에서는 특정 도메인 (AWS EC2 인스턴스 주소) 허용
...
app.include_router(
    unified_audio_router, prefix="/wss/v1"  # /wss/v1/audio 통합 엔드포인트
)
